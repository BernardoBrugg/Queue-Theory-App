...
const WORKFLOW_STEPS = [
  ...
  { step: 2, href: ROUTES.data, title: "Revisar Dados", desc: "Visualize e exporte registros", color: "#3b82f6" },
  { step: 3, href: ROUTES.dashboards, title: "Ver Métricas", desc: "Gráficos e análise automática", color: "#10b981" },
];
